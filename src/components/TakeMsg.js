...
class TakepMsg extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleValidation() {
        ...
        if (EmployeeSerialNumber === null || EmployeeSerialNumber === "") {
            ...
            this.setState({ err: 0 });
            this.props.onDecrement(EmployeeSerialNumber);
        }
    }
        ...
        return (
            <div className="modalBackground">
                <div className="modalContainer">
                    ...
                    <TextField required id="outlined-basic" label="Please enter your Employee Serial Number" inputProps={{ style: { textAlign: "center" } }} onChange={(e) => this.handleInput(e)} />
                    {this.state.err === 1 ? <div className="errMsg">This field is required!</div> : null}
